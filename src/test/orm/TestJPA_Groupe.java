...
public class TestJPA_Groupe {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\tpersistance demandée ; vérification par recherche sur l'identifiant du groupe : " + unGroupe2.getIdGroupe());
        unGroupe2Lu =  em.find(Groupe.class, unGroupe2.getIdGroupe());
        unGroupe3Lu =  em.find(Groupe.class, unGroupe3.getIdGroupe());
        System.out.println("\tGroupe d'identifiant : " + unGroupe2.getIdGroupe() + " : " + unGroupe2Lu.toString());
        System.out.println("\tGroupe d'identifiant : " + unGroupe3.getIdGroupe() + " : " + unGroupe3Lu.toString());
        ...
        System.out.println("\tmodification demandée ; vérification par recherche sur l'identifiant du groupe : " + unGroupe2.getIdGroupe());
        unGroupe2Lu =  em.find(Groupe.class, unGroupe2.getIdGroupe());
        System.out.println("\tGroupe d'identifiant : " + unGroupe2.getIdGroupe() + " : " + unGroupe2Lu.toString());
        ...
        System.out.println("\tsuppression effectuée ; vérification par recherche sur l'identifiant du groupe : " + unGroupeSuppr.getIdGroupe());
        unGroupe2Lu =  em.find(Groupe.class, unGroupe2.getIdGroupe());
        if (unGroupe2Lu == null) {
            System.out.println("\tsuppression réussie");
        } else {
            System.out.println("\téchec de la suppression : " + unGroupe2.getIdGroupe() + " : " + unGroupe2Lu.toString());
        }
